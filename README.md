...
<section class="bg-primary text-white text-center p-5">
    <div class="container">
        <h1>Welcome to TechFix Computer Services</h1>
        <p>Your trusted partner for computer repair and IT solutions</p>
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">We fix hardware and software problems efficiently.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Laptop Maintenance</h5>
            <p class="card-text">Cleaning, upgrades, and performance optimization.</p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            ...
            <p class="card-text">Professional internet and LAN installation services.</p>
          </div>
        </div>
      </div>
    </div>
